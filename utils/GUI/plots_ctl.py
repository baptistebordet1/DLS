...
class plot_control_auto_corr(container.QGroupBoxContainer):
    def setup(self, plot_auto_corr):
        ...
        with self.params.using_new_sublayout("Xrange", "hbox",location=("next")):
        ...
        self.params.add_combo_box("Log-Lin scale", value=1, options=["Log", "Lin"],index_values=[1,0],label = "Set X-scale : ").get_value_changed_signal().connect(self.change_scale)
